...
public class TrackerTest {
    ...
    public void TestNullImputs() {
        ...
        Assert.Throws(typeof(XApiException), delegate {
            t.ActionTrace("Verb","Type", "ID");
            t.RequestFlush();
            t.Update();
        });
    ...
    public void TestObsoleteMethods() {
        ...
        Assert.Throws(typeof(TraceException), delegate { t.Trace("1,2,3,4"); });
        Assert.Throws(typeof(XApiException), delegate { t.Trace("1,2,3"); t.RequestFlush(); t.Update(); });
    ...
    private void CompareCSV(string t1, string t2){
        string[] sp1 = sliceCSV(t1);
        string[] sp2 = sliceCSV(t2);
    ...
    private string[] sliceCSV(string trace){
