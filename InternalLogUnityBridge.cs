...
namespace AssetPackage
{
    ...
    public class InternalLogUnityBridge : IBridge, IDataStorage, IAppend, IWebServiceRequest, ILog
    {
        ...
        {
            QuizDemo.Log.L().AddLogLine(fileData.Replace(" ", "").Replace("\n", "").Replace("},{", "},\n{"));
        ...
        private RequestResponse WebServiceRequest(RequestSetttings requestSettings)
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(requestSettings.body))
                {
                    ...
                    QuizDemo.Log.L().AddLogLine(requestSettings.body.Replace(" ", "").Replace("\n", "").Replace("},{", "},\n{"));
